...
#### python new_ideeps.py --train=True --data_file=1_PARCLIP_AGO1234_hg19/30000/training_sample_0/sequences.fa.gz --model_dir=models
#### python new_ideeps.py --train=True --data_file=2_PARCLIP_AGO2MNASE_hg19/30000/training_sample_0/sequences.fa.gz --model_dir=models
...
def merge_seperate_network(X_train1, X_train2, Y_train):
    ...
    model = Sequential()
    model.add(Concatenate(axis=-1)([left, right]))
...
def get_transformers_network():
    ...
    model.add(Concatenate(axis=-1)([seq_model, struct_model]))
